...
IMAGES = [
    ...
    CONF.cloud_controller_manager.v1_22_image,
    CONF.cloud_controller_manager.v1_23_image,
    CONF.cloud_controller_manager.v1_24_image,
    CONF.cloud_controller_manager.v1_25_image,
    CONF.cloud_controller_manager.v1_26_image,
    CONF.csi.attacher_image,
    CONF.csi.liveness_probe_image,
    CONF.csi.node_driver_registrar_image,
    CONF.csi.provisioner_image,
    CONF.csi.resizer_image,
    CONF.csi.snapshotter_image,
    images.PAUSE,
]
