...
mod tests {
    ...
    fn renders_only_with_an_explicit_vip_and_interface() {
        ...
        values.api_server_fixed_ip = "192.0.2.70".into();
        values.api_server_fixed_ip_managed = true;
        values.kube_vip_interface = "eth0".into();
        ...
        assert!(content.contains("value: \"eth0\""));
        assert!(content.contains("value: \"192.0.2.70\""));
